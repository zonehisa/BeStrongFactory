        ...
        <div class="flex-1 p-4 md:p-6 ml-64 mt-16">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <a href="{{ route('inventories.index') }}"
                    class="text-gray-500 hover:text-gray-700 font-bold py-2 px-4 mb-4 transition-transform transform hover:-translate-x-1">
                    <i class="fas fa-arrow-left"></i> 在庫一覧へ戻る
                </a>
