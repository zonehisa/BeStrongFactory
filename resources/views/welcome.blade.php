                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                            <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill="#FF2D20" d="M23 4a1 1 0 0 0-1.447-.894L12.224 7.77a.5.5 0 0 1-.448 0L2.447 3.106A1 1 0 0 0 1 4v13.382a1.99 1.99 0 0 0 1.105 1.79l9.448 4.728c.14.065.293.1.447.1.154-.005.306-.04.447-.105l9.453-4.724a1.99 1.99 0 0 0 1.1-1.789V4Z"/></svg>
                                        </div>

                                        <div class="pt-3 sm:pt-5">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">在庫管理システム</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                シンプルで使いやすい在庫管理システムです。商品の入出庫を簡単に記録でき、在庫状況をリアルタイムで把握できます。
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill="#FF2D20" d="M12 .5a11.5 11.5 0 0 0 0 23 11.5 11.5 0 0 0 0-23ZM5 12a7 7 0 0 1 7-7 7 7 0 0 1 7 7 7 7 0 0 1-7 7 7 7 0 0 1-7-7Z"/></svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">簡単操作</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        直感的なインターフェースで、誰でも簡単に操作できます。在庫の入力や確認がスムーズに行えます。
                                    </p>
                                </div>
                            </a>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill="#FF2D20" d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm0-18a8 8 0 1 1 0 16 8 8 0 0 1 0-16Z"/><path fill="#FF2D20" d="m12 6 4 4-4 4-4-4 4-4Z"/></svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">データ管理</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        在庫データを一元管理し、過去の履歴も簡単に確認できます。在庫状況のレポート出力機能も搭載しています。
                                    </p>
                                </div>
                            </a>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill="#FF2D20" d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16Z"/><path fill="#FF2D20" d="M12 6a1 1 0 0 0-1 1v5H7a1 1 0 1 0 0 2h5a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1Z"/></svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">リアルタイム更新</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        在庫データはリアルタイムで更新され、常に最新の情報を確認できます。在庫切れの防止や適切な在庫管理に役立ちます。
                                    </p>
                                </div>
                            </div>
                        </div>
