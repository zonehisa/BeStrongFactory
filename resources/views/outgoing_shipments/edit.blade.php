                    ...
                    <div class="p-6 text-gray-900">
                        <form method="POST" action="{{ route('outgoing_shipments.update', $outgoingShipment) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="hidden" name="inventory_id" value="{{ $outgoingShipment->inventory_id }}">
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="shipped_date" class="block text-gray-700 text-sm font-bold mb-2">出荷日</label>
